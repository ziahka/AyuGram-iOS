...
final class LegacyGlassView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        let backdropLayer = createBackdropLayer()
    ...
    func update(size: CGSize, cornerRadius: CGFloat, transition: ComponentTransition) {
        ...
        if let fallbackEffectView = self.fallbackEffectView {
            transition.setFrame(view: fallbackEffectView, frame: CGRect(origin: CGPoint(), size: size))
            transition.setCornerRadius(layer: fallbackEffectView.layer, cornerRadius: cornerRadius)
        }
