...
class AudioDeviceModuleIOS : public AudioDeviceModule {
 public:
  ...
  void setDarkgramVoiceLab(bool enabled, int32_t pitchCents, int32_t outputGainPercent);
 ...
 private:
  ...
  std::optional<std::tuple<bool, int32_t, int32_t>> pendingDarkgramVoiceLabConfiguration_;
};
}  // namespace tgcalls_ios_adm
}  // namespace webrtc
